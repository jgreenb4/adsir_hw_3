...
```{r}
# creates table w/ aggregated training accuracies
modeling_accuracy_table <- formattable(results_pitches[1:4, 1:2], color = "Black", list( `Player` = formatter("span", style = ~ style(color
= "#2F241D",font.weight = "bold"))))
kable(modeling_accuracy_table) %>%
